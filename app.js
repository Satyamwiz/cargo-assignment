...
const STEPS = [
  ...
  {
    id: 'fragile',
    bot: '<strong>Question 1 of 7 — Fragility</strong><br><br>Is your cargo fragile? This includes glassware, precision instruments, or sensitive electronics.',
    type: 'yesno',
    choices: [
  ...
  {
    id: 'heavy',
    bot: '<strong>Question 2 of 7 — Weight</strong><br><br>Is the cargo heavy? For example, industrial machinery, engine parts, or dense materials.',
    type: 'yesno',
    choices: [
  ...
  {
    id: 'perishable',
    bot: '<strong>Question 3 of 7 — Perishability</strong><br><br>Is the cargo perishable? This includes food, dairy, fresh produce, biologics, or pharmaceuticals.',
    type: 'yesno',
    choices: [
  ...
  },
  {
    ...
    bot: '<strong>Question 5 of 7 — Temperature Sensitivity</strong><br><br>Is the cargo sensitive to temperature fluctuations or weather conditions during transit?',
    type: 'yesno',
    choices: [
  ...
  {
    id: 'urgency',
    bot: '<strong>Question 6 of 7 — Delivery Urgency</strong><br><br>Does this shipment require urgent or priority delivery? e.g. same-day, express, or time-critical cargo.',
    type: 'yesno',
    choices: [
  ...
  {
    id: 'traffic',
    bot: '<strong>Question 7 of 7 — Airport Congestion</strong><br><br>Is the destination airport typically experiencing high traffic or congestion during standard hours?',
    type: 'yesno',
    choices: [
...
function handleAnswer(stepId, rawValue) {
  ...
  applyScore(stepId, rawValue);        // ← GREEDY scoring step
...
function evaluate() {
  ...
  showTyping(() => {
    addBotMessage('✅ <strong>Assessment complete.</strong> Your expert cargo report has been generated using the <strong>Greedy Algorithm</strong> (container scoring) and <strong>A* Search</strong> (route optimisation). Open the <strong>Verdict Report</strong> panel.');
    chatFooter.innerHTML = `
...
<div class="report-page">
  ...
  <div class="report-header-card">
    <div class="report-header-left">
      ...
      <p>Generated by AeroCargoIQ using Greedy Algorithm + A* Search</p>
  ...
  <div class="container-hero" style="background:${containerMeta.bg};border-color:${containerMeta.border}">
    ...
    <div>
      <div class="container-hero-type" style="color:${containerMeta.color}">
        🧮 GREEDY ALGORITHM RESULT — RECOMMENDED CONTAINER TYPE
      </div>
  ...
  <div class="report-section" style="border-color:rgba(79,140,255,.25)">
    <div class="rs-header" style="background:rgba(79,140,255,.07)">
      <span class="rs-icon">🧮</span>
      <span class="rs-title" style="color:#4f8cff">GREEDY ALGORITHM — STEP-BY-STEP SCORING TRACE</span>
    </div>
    <div style="padding:16px 20px">
      <div style="font-size:12px;color:#64748b;margin-bottom:14px">
        At each rule-firing step, the engine greedily updates the most-evidenced container score.
        Final container = <strong style="color:#4f8cff">argmax(scores)</strong> — the greedy global optimum.
      </div>
      <div class="log-table-wrap">
        <table>
          <thead><tr><th>RULE / QUESTION</th><th>ANSWER</th><th>SCORE UPDATE</th><th>GREEDY BEST (so far)</th></tr></thead>
  ...
  <div class="report-note">
    ...
    <strong style="color:#4f8cff">① Greedy Algorithm (Container Selection)</strong> — 
    A rule-based weighted scoring system fires on each user answer and greedily accumulates evidence points for each container category (Glass, Metal, Refrigerated, Standard). The final recommendation is determined by <em>argmax(scores)</em> — the container with the highest cumulative weighted score. This is optimal under the stated rules because each scoring rule is independent (no backtracking needed).<br><br>
...
function formatDisplay(id, v) {
  if (id==='distance')   return `📍 ${Number(v).toLocaleString()} km`;
